...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, NavigationLisitner, NetworkCallBack {
    ...
    private void uploadContacts() {
        List<Contact> listContacts = new ContactFetcher(this).fetchAll();
        System.out.println("HomeActivity.uploadContacts" + SharedPrefrenceHandler.getInstance().getUSER_TOKEN());
...
// Adding request to request queue
    ...
    /*-------------------------*/
    private class DownloadTask extends AsyncTask<List<com.mobileoid2.celltone.pojo.getmedia.Body>, Integer, String> {
